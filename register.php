      ...
      <div class="register_info ">
        ...
        <form>
          ...
          <div class="row p-2">
            ...
            <div class="col-md-12 pb-4">
              <input type="number" class="form-control" placeholder="Phone" aria-label="register_phone">
            </div>
            <div class="col-md-12 pb-4">
              <input type="text" class="form-control" placeholder="Address" aria-label="register_address">
            </div>
            <div class="col-md-12 pb-4">
              <input type="number" class="form-control" placeholder="Age" aria-label="register_age">
            </div>
            ...
            <div class="col-12 pb-3">
              <div class="form-check">
                ...
                <label class="form-check-label" for="gridCheck" style="color: white;">
                  I accept <span class="login_text"><a href="terms.html" style="text-decoration: none;">Terms of
                      Use</a></span>
                </label>
              </div>
            </div>
            <div class="col-md-12 text-center pb-3">
              <button type="submit" class="btn btn-primary"><a href="index.html">Sign Up</a></button>
            </div>
          </div>
        </form>
      </div>
