 ...
 <section class="terms" id="terms">
    <div class="layer">
      <div class="terms_info">
        <img src="image/logo.png" alt="" class="terms_logo">
        <h5>Welcome to our restaurant website! By accessing and using this website, you agree to comply with and be
          bound by the following terms and conditions of use:</h5>
          <br>
        <ul>
          <ol>
            <li>The content of this website is for your general information and use only. It is subject to change
              without notice.</li>
            ...
            <li>Your use of this website and any dispute arising out of such use of the website is subject to the laws
              of [insert country/state/province here].</li>
          </ol>
        </ul>
        <p>Thank you for using our restaurant website, and we hope you enjoy your visit!</p>
        <button type="submit" class="btn btn-primary"><a href="register.html">Back to Signup page</a></button>
      </div>
    </div>
  </section>
